...
public final class ViewHolderBinding implements ViewBinding {
  ...
  private ViewHolderBinding(@NonNull LinearLayout rootView, @NonNull ImageView imageView,
  ...
  public static ViewHolderBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.view_holder, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static ViewHolderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ViewHolderBinding((LinearLayout) rootView, imageView, textView, textView2);
    }
